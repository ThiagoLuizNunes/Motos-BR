...
"use strict";angular.module("motorcycleBR").config(["$stateProvider","$urlRouterProvider",function(t,o){t.state("dashboard",{url:"/dashboard",templateUrl:"dashboard/dashboard.html"}).state("motorcycle",{url:"/motorcycle?page",templateUrl:"motorcycle/tabs.html"})}]).run(["$rootScope","$http","$location","$window","auth",function(t,o,a,e,r){function l(){var t=r.getUser(),l=e.location.href.includes("/auth.html");t||l?t&&!t.isValid&&r.validateToken(t.token,function(r,n){n?(t.isValid=!0,o.defaults.headers.common.Authorization=t.token,l?e.location.href="/":a.path("/dashboard")):e.location.href="/auth.html"}):e.location.href="/auth.html"}l(),t.$on("$locationChangeStart",function(){return l()})}]);
