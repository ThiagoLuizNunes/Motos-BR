...
"use strict";!function(){angular.module("motorcycleBR").controller("MotorcycleCtrl",["$http","$location","msgs","sort","tabs",function(a,o,e,t,c){var r=this,n="http://localhost:4000/api/motorcycle";r.refresh=function(){var e=parseInt(o.search().page)||1;a.get(n+"?skip="+10*(e-1)+"&limit=10").then(function(o){r.motorcycle={},r.motorcycles=t.Data(o.data),c.show(r,{tabList:!0,tabCreate:!0,tabSearch:!0}),a.get(n+"/count").then(function(a){r.pages=Math.ceil(a.data.value/10)})})},r.create=function(){a.post(n,r.motorcycle).then(function(a){r.refresh(),e.addSuccess("Operação realizada com sucesso!")}).catch(function(a){e.addError(a.data.errors)})},r.update=function(){var o=n+"/"+r.motorcycle._id;a.put(o,r.motorcycle).then(function(a){r.refresh(),e.addSuccess("Operação realizada com sucesso!")}).catch(function(a){e.addError(a.data.errors)})},r.delete=function(){var o=n+"/"+r.motorcycle._id;a.delete(o,r.motorcycle).then(function(a){r.refresh(),e.addSuccess("Operação realizada com sucesso!")}).catch(function(a){e.addError(a.data.errors)})},r.showTabUpdate=function(a){r.motorcycle=a,c.show(r,{tabUpdate:!0})},r.showTabDelete=function(a){r.motorcycle=a,c.show(r,{tabDelete:!0})},r.search=function(){r.nameChoice?void 0!=r.choice?a.get("http://localhost:4000/search-name/"+r.choice).then(function(a){0!=a.data.length?(r.motorcycles=a.data,console.log(a.data)):(r.refresh(),e.addError("Busca não encontrada"))}).catch(function(a){e.addError(a.data.errors)}):(r.refresh(),e.addWarning("Campo vazio!")):r.brandChoice?void 0!=r.choice?a.get("http://localhost:4000/search-brand/"+r.choice).then(function(a){0!=a.data.length?(r.motorcycles=t.Data(a.data),console.log(a.data)):(r.refresh(),e.addError("Busca não encontrada"))}).catch(function(a){e.addError(a.data.errors)}):(r.refresh(),e.addWarning("Campo vazio!")):(e.addWarning("Selecione uma categoria!"),r.refresh())},r.refresh()}])}();
