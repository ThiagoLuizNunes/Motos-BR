...
"use strict";angular.module("motorcycleBR").config(["$stateProvider","$urlRouterProvider",function(t,r){t.state("dashboard",{url:"/dashboard",templateUrl:"dashboard/dashboard.html"}).state("motorcycle",{url:"/motorcycle",templateUrl:"motorcycle/tabs.html"})}]);
"use strict";!function(){angular.module("motorcycleBR").controller("DashboardCtrl",["$http",function(t){var o=this;o.getTotalMotorcycle=function(){t.get("http://motosbr.herokuapp/api/motorcycle/count").then(function(t){o.count=t.data.value})},o.getTotalMotorcycle()}])}();
"use strict";!function(){angular.module("motorcycleBR").controller("MotorcycleCtrl",["$http",function(t){this.create=function(){}}])}();
...
"use strict";!function(){angular.module("motorcycleBR").factory("tabs",[function(){return{show:function(t,a){var e=a.tabList,o=void 0!==e&&e,i=a.tabCreate,b=void 0!==i&&i,r=a.tabUpdate,n=void 0!==r&&r,c=a.tabDelete,d=void 0!==c&&c;t.tabList=o,t.tabCreate=b,t.tabUpdate=n,t.tabDelete=d}}}])}();