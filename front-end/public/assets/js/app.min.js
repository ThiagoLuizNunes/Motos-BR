...
"use strict";!function(){angular.module("motorcycleBR").controller("AuthCtrl",["$location","msgs","auth",function(n,o,t){var u=this;u.loginMode=!0,u.changeMode=function(){return u.loginMode=!u.loginMode},u.login=function(){t.login(u.user,function(n){return n?o.addError(n):o.addSuccess("Sucesso")})},u.signup=function(){t.signup(u.user,function(t){return t?o.addError(t):n.path("/")})},u.getUser=function(){return t.getUser()},u.logout=function(){t.logout(function(){return n.path("/")})}}])}();
...
"use strict";!function(){angular.module("motorcycleBR").factory("auth",["$http","consts",function(t,n){function o(o,u,a){t.post(n.oapiUrl+"/"+o,u).then(function(o){localStorage.setItem(n.userKey,JSON.stringify(o.data)),t.defaults.headers.common.Authorization=o.data.token,a&&a(null,o.data)}).catch(function(t){console.log("Deu ERRO em SUBMIT"),console.log(t),a&&a(t.data.errors,null)})}return{signup:function(t,n){o("signup",t,n)},login:function(t,n){o("login",t,n)}}}])}();
