...
"use strict";angular.module("motorcycleBR").constant("consts",{appName:"Motorcycle BR",version:"1.0",owner:"Thiago Luiz",year:"2017",site:"https://github.com/ThiagoLuizNunes",apiUrl:"http://localhost:4000/api",oapiUrl:"http://localhost:4000",userKey:"_motorcycle_app_user"}).run(["$rootScope","consts",function(o,t){o.consts=t}]);
"use strict";angular.module("motorcycleBR").config(["$stateProvider","$urlRouterProvider","$httpProvider",function(t,o,a){t.state("dashboard",{url:"/dashboard",templateUrl:"dashboard/dashboard.html"}).state("motorcycle",{url:"/motorcycle?page",templateUrl:"motorcycle/tabs.html"}),a.interceptors.push("handleResponseError")}]).run(["$rootScope","$http","$location","$window","auth",function(t,o,a,r,e){function n(){var t=e.getUser(),n=r.location.href.includes("/auth.html");t||n?t&&!t.isValid&&e.validateToken(t.token,function(e,l){l?(t.isValid=!0,o.defaults.headers.common.Authorization=t.token,n?r.location.href="/":a.path("/dashboard")):r.location.href="/auth.html"}):r.location.href="/auth.html"}n(),t.$on("$locationChangeStart",function(){return n()})}]);
"use strict";!function(){angular.module("motorcycleBR").controller("AuthCtrl",["$location","msgs","auth",function(n,o,t){var r=this;r.loginMode=!0,r.changeMode=function(){return r.loginMode=!r.loginMode},r.login=function(){t.login(r.user,function(t){return t?o.addError(t):n.path("/")})},r.signup=function(){t.signup(r.user,function(t){return t?o.addError(t):n.path("/")})},r.getUser=function(){return t.getUser()},r.logout=function(){t.logout(function(){return n.path("/")})}}])}();
...
"use strict";!function(){angular.module("motorcycleBR").factory("auth",["$http","consts",function(t,o){function n(){return l||(l=JSON.parse(localStorage.getItem(o.userKey))),l}function e(n,e,a){t.post(o.oapiUrl+"/"+n,e).then(function(n){localStorage.setItem(o.userKey,JSON.stringify(n.data)),t.defaults.headers.common.Authorization=n.data.token,a&&a(null,n.data)}).catch(function(t){console.log("Deu ERRO em SUBMIT"),console.log(t),a&&a(t.data.errors,null)})}function a(n){l=null,localStorage.removeItem(o.userKey),t.defaults.headers.common.Authorization="",n&&n(null)}var l=null;return{signup:function(t,o){e("signup",t,o)},login:function(t,o){e("login",t,o)},logout:a,getUser:n,validateToken:function(e,l){e?t.post(o.oapiUrl+"/validateToken",{token:e}).then(function(o){o.data.valid?t.defaults.headers.common.Authorization=n().token:a(),l&&l(null,o.data.valid)}).catch(function(t){l&&l(t.data.errors)}):l&&l("Token inválido.")}}}])}();
...
"use strict";!function(){angular.module("motorcycleBR").factory("handleResponseError",["$q","$window","consts",function(r,e,o){return{responseError:function(t){return 403===t.status&&(localStorage.removeItem(o.userKey),e.location.href="/"),r.reject(t)}}}])}();
