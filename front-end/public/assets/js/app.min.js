...
"use strict";angular.module("motorcycleBR").config(["$stateProvider","$urlRouterProvider",function(t,r){t.state("dashboard",{url:"/dashboard",templateUrl:"dashboard/dashboard.html"}).state("motorcycle",{url:"/motorcycle?page",templateUrl:"motorcycle/tabs.html"})}]);
...
"use strict";!function(){angular.module("motorcycleBR").controller("MotorcycleCtrl",["$http","$location","msgs","sort","tabs",function(o,a,t,e,c){var r=this,n="http://localhost:4000/api/motorcycle";r.refresh=function(){var t=parseInt(a.search().page)||1;o.get(n+"?skip="+10*(t-1)+"&limit=10").then(function(a){r.motorcycle={},r.motorcycles=e.Data(a.data),c.show(r,{tabList:!0,tabCreate:!0,tabSearch:!0}),o.get("https://motosbr.herokuapp.com/api/motorcycle/count").then(function(o){r.pages=Math.ceil(o.data.value/10)})})},r.create=function(){o.post(n,r.motorcycle).then(function(o){r.refresh(),t.addSuccess("Operação realizada com sucesso!")}).catch(function(o){t.addError(o.data.errors)})},r.update=function(){var a=n+"/"+r.motorcycle._id;o.put(a,r.motorcycle).then(function(o){r.refresh(),t.addSuccess("Operação realizada com sucesso!")}).catch(function(o){t.addError(o.data.errors)})},r.delete=function(){var a=n+"/"+r.motorcycle._id;o.delete(a,r.motorcycle).then(function(o){r.refresh(),t.addSuccess("Operação realizada com sucesso!")}).catch(function(o){t.addError(o.data.errors)})},r.showTabUpdate=function(o){r.motorcycle=o,c.show(r,{tabUpdate:!0})},r.showTabDelete=function(o){r.motorcycle=o,c.show(r,{tabDelete:!0})},r.search=function(){r.nameChoice?void 0!=r.choice?o.get("http://localhost:4000/search-name/"+r.choice).then(function(o){0!=o.data.length?(r.motorcycles=o.data,console.log(o.data)):(r.refresh(),t.addError("Busca não encontrada"))}).catch(function(o){t.addError(o.data.errors)}):(r.refresh(),t.addWarning("Campo vazio!")):r.brandChoice?void 0!=r.choice?o.get("http://localhost:4000/search-brand/"+r.choice).then(function(o){0!=o.data.length?(r.motorcycles=e.Data(o.data),console.log(o.data)):(r.refresh(),t.addError("Busca não encontrada"))}).catch(function(o){t.addError(o.data.errors)}):(r.refresh(),t.addWarning("Campo vazio!")):(t.addWarning("Selecione uma categoria!"),r.refresh())},r.refresh()}])}();
