...
"use strict";!function(){angular.module("motorcycleBR").controller("DashboardCtrl",["$http",function(t){var o=this;o.getTotalMotorcycle=function(){t.get("htt://localhost:4000/api/motorcycle/count").then(function(t){o.count=t.data.value})},o.getTotalMotorcycle()}])}();
